  ...
  content: [
    ...
    },
    {
      ...
      table: {
        ...
        body: [
          [
            { text: 'GOUKEI', fillColor: '#bdcf99' },
            { text: 'W/O TAX ¥' + nonTaxedPrice, alignment: 'right' },
            { text: 'With TAX ¥' + tax, alignment: 'right' },
            { text: 'Total ¥' + totalAmount, alignment: 'right' }
          ],
        ]
      },
