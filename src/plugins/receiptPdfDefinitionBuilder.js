...
const builder = {
  ...
  docContent: function(customer, billingItems){
    ...
    const tableItems = [
      [
        { text: '品名', fillColor: '#99bdcf'},
        { text: '単価', fillColor: '#99bdcf'},
        { text: '数量', fillColor: '#99bdcf'},
        { text: '単位', fillColor: '#99bdcf'},
        { text: '金額', fillColor: '#99bdcf'}
      ],
      ...
      [
        ...
        },
        {
          columns: [
            ...
            },
            {
              margin: [30, 10, 0, 0],
              text: [
                { text: '発行日: ' + issuedDate, fontSize: 10, bold: true },
                '\n',
                { text: '領収書番号: ' + receiptNumber, fontSize: 10, bold: true },
                '\n',
                '\n',
                { text: 'ビズアプリ製作所', fontSize: 10, bold: true },
                '\n',
          ...
          columns: [
            {
              ...
              width: 280,
              text: [
                // { text: '平素は格別のご高配を賜り厚く御礼申し上げます。', fontSize: 10, bold: true },
                // '\n',
          ...
          columns: [
            ...
            },
            {
              ...
              text: [
                // { text: '平素は格別のご高配を賜り厚く御礼申し上げます。', fontSize: 10, bold: true },
                // '\n',
                { text: '下記、正に領収致しました。', fontSize: 10, bold: true },
                '\n',
                { text: '金額    ¥' + totalAmountText + '  ', fontSize: 16, bold: true, decoration: 'underline' },
              ]
            },
          ]
        },
        ...
        },
        {
          ...
          table: {
            ...
            body: [
              [
                { text: '合計', fillColor: '#99bdcf', fontSize: 12 },
        ...
        //       margin: [0, 0, 0, 0],
        //       text: [
        //         { text: '<振込先> 下記の口座にお振り込み下さい。尚、振込手数料は御社でご負担願います。', fontSize: 10, bold: true },
        //         '\n',
        //         { text: '三菱東京UFJ銀行  表参道支店', fontSize: 10, bold: true },
        //         '\n',
        //         { text: '普通口座  0700474  口座名義  ナカチ ハルオ', fontSize: 10, bold: true },
        //       ]
        //     },
        //   ]
        // },
